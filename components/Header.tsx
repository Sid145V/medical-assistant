...
const Header: React.FC = () => {
  ...
  const navLinkClasses = "relative text-text-light dark:text-text-dark hover:text-primary transition-colors duration-300 after:content-[''] after:absolute after:left-0 after:bottom-[-4px] after:w-0 after:h-[2px] after:bg-primary after:transition-all after:duration-300";
  ...
  return (
    <header className="bg-card-light/80 dark:bg-card-dark/80 backdrop-blur-md sticky top-0 z-50 border-b border-white/30 dark:border-white/10">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            <div className="hidden md:flex items-center space-x-4">
               <motion.button onClick={toggleTheme} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="p-2 rounded-full hover:bg-black/5 dark:hover:bg-white/5">
               ...
               <motion.button onClick={toggleSound} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="p-2 rounded-full hover:bg-black/5 dark:hover:bg-white/5">
            ...
            <div className="md:hidden">
                <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} aria-label="Open menu" className="text-text-light dark:text-text-dark">
       ...
       <AnimatePresence>
        {mobileMenuOpen && (
            <motion.div
                ...
                className="md:hidden glass-card rounded-t-none border-t border-white/20 dark:border-white/10"
            >
